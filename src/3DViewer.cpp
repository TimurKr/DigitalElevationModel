...
3DViewer ::3DViewer(QWidget *parent)
	: QMainWindow(parent), ui(new Ui::3DViewerClass)
{
	ui->setupUi(this);
...
// Event filters
bool 3DViewer ::eventFilter(QObject *obj, QEvent *event)
{
...
// ViewerWidget Events
bool 3DViewer ::ViewerWidgetEventFilter(QObject *obj, QEvent *event)
{
...
void 3DViewer ::ViewerWidgetMouseButtonPress(ViewerWidget *w, QEvent *event)
{
...
void 3DViewer ::ViewerWidgetMouseButtonRelease(ViewerWidget *w, QEvent *event)
{
	QMouseEvent *e = static_cast<QMouseEvent *>(event);
...
void 3DViewer ::ViewerWidgetMouseMove(ViewerWidget *w, QEvent *event)
{
	QMouseEvent *e = static_cast<QMouseEvent *>(event);
...
void 3DViewer ::ViewerWidgetLeave(ViewerWidget *w, QEvent *event)
{
}
void 3DViewer ::ViewerWidgetEnter(ViewerWidget *w, QEvent *event)
{
}
void 3DViewer ::ViewerWidgetWheel(ViewerWidget *w, QEvent *event)
{
...
// 3DViewer Events
void 3DViewer ::closeEvent(QCloseEvent *event)
{
...
// Image functions
bool 3DViewer ::openImage(QString filename)
{
...
bool 3DViewer ::saveImage(QString filename)
{
...
// Hermit Functions
void 3DViewer ::setHermitBox(bool state, int n)
{
...
void 3DViewer ::on_direction_spinbox_valueChanged(int new_direction)
{
	{
...
void 3DViewer ::on_length_spinbox_valueChanged(int new_length)
{
	{
		vW->editHermitPointTangent(
			ui->n_spinbox->value(),
...
// Slots
void 3DViewer ::on_actionOpen_triggered()
{
...
void 3DViewer ::on_actionSave_as_triggered()
{
...
void 3DViewer ::on_actionClear_triggered()
{
	vW->clear();
}
void 3DViewer ::on_actionExit_triggered()
{
	this->close();
}

void 3DViewer ::on_pushButtonSetColor_clicked()
{
